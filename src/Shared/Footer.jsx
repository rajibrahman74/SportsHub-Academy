...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-100 via-[#5db6fb] to-gray-100">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <img src={logo} className="mr-5 h-6 md:h-7" alt="logo" />
            <p className="max-w-xs mt-4 text-sm text-gray-600">
              Athletic excellence nurtured through comprehensive training at
              Sports Hub Academy.
            </p>
        ...
        <p className="mt-8 text-xs text-gray-800">© 2023 SportHub Academy</p>
      </div>
    </footer>
  );
};
